...
class SEBlock(nn.Module):
    def __init__(self, in_channels,out_channels,hsigmoid_type='others',ration=4):
        super().__init__()
        ...
        self.relu1 = nn.ReLU()
        self.conv2 = nn.Conv2d(in_channels=num_mid_filter,out_channels=out_channels,kernel_size=1,bias=True)
